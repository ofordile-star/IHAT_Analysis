...
output_base <- "C:/Users/oofordile/Desktop/maaslin2_output"
...
# --- Define explicit pairwise comparisons and references (13 total) ---
...
message("All 13 pairwise Maaslin2 analyses complete!")
